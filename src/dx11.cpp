...
D3D11Core::D3D11Core(void* hWnd, int width, int height)
{
	...
	CHECK_DX(D3D11CreateDevice,
		...
		nullptr,
		USE_DEBUG_DEVICE ? D3D11_CREATE_DEVICE_DEBUG : 0,
		nullptr,
		0,
		D3D11_SDK_VERSION,
		&m_pDevice,
...
void D3D11Core::create_render_scene()
{
	m_pRenderScene = new RenderScene(this);
}
